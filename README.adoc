...
|Select more/less incrementally|kbd:[Ctrl+Space] kbd:[Ctrl+Backspace]
|Save current buffer|kbd:[Ctrl+S]
|Search help|kbd:[<F1>]
|Floating terminal|kbd:[<leader>`]
|Find a buffer|kbd:[<leader>b/]
...
[source,sh]
----
git clone https://github.com/jakelogemann/nvim-config.git ~/.config/nvim
----
